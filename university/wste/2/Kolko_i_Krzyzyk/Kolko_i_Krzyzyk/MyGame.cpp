...
void MyGame::drawWinScene(sf::RenderWindow &gameWindow, int side)
{
	...
	winText.setPosition(40.0, 250.0);
...
bool MyGame::handleClick(std::vector<std::vector<int>> &gameBoard, int side, int io, int jo)
{
	int i, j;

	//searching for clicked element and getting is into table array - clicked middle = board[1][1]
